...
<div class="container-fluid m-3">	
    			...
    			<li class="list-group-item" data-id="<?php echo $row['id'] ?>" data-price="<?php echo $row['price'] ?>">
    				<div class="d-flex w-100">
    					...
    					<div class="detail-field">
    						...
    						<p>Price:Tk. <b><?php echo number_format($row['price'],2) ?></b></p>
    ...
    <div class="col-md-4">
    	<div class="card mb-4">
    		<div class="card-header bg-primary text-white"><b>Total Amount (After 10% Discount)</b></div>
    		<div class="card-body">
    			<h4 class="text-right">Tk. <b id="tamount"><?php echo number_format($total,2) ?></b></h4>
    		</div>
    	</div>
     ...
     function calc(){
     	...
     	$('.amount').each(function(){
     		var amount = $(this).text()
     			...
     			var discount =parseFloat(0.1*amount);
                var discount_price =(parseFloat(amount)-discount);
